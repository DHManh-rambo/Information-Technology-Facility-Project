...
<style>
    #ajax-content .badge-dang-ban  { background: #d1f5d3; color: #1a7f37; }
    #ajax-content .badge-ngung-ban { background: #fde8e8; color: #c0392b; }
    #ajax-content table img { border-radius: 8px; object-fit: cover; }
    #ajax-content .btn-sm { border-radius: 6px; }
    #ajax-content .preview-img { max-height: 120px; border-radius: 8px; display: none; margin-top: 8px; }
    #ajax-content #cardForm.che-do-sua { outline: 2px solid #ffc107; }
</style>
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                @if($sp->hinh_anh)
                                    <img src="{{ asset($sp->hinh_anh) }}" alt="{{ $sp->ten_san_pham }}" width="60" height="60">
                                @else
                                    <img src="{{ asset('img/default.jpg') }}" alt="Chưa có ảnh" width="60" height="60">
                                @endif
                            </td>
